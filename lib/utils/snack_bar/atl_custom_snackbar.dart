import 'package:atlsnackbar/constant/img_const.dart';
import 'package:atlsnackbar/utils/snack_bar/content_type.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'dart:ui' as ui;

class AtlCustomSnackBar extends StatelessWidget {
  ...
  String assetSVG(ContentType contentType) {
    switch (contentType) {
      case ContentType.failure:
        ...
        return ImageConst.failure;
      case ContentType.success:

        /// success will show `CHECK`
        return ImageConst.success;
      case ContentType.warning:

        /// warning will show `EXCLAMATION`
        return ImageConst.warning;
      case ContentType.help:

        /// help will show `QUESTION MARK`
        return ImageConst.help;
      default:
        return ImageConst.failure;
    }
  }
